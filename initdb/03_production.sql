-- =============================================================================
-- Tesla OEM Lakehouse - production schema: 工厂 / 产线 / 工艺路线 / 生产订单 / 质量
-- PostgreSQL 16
-- =============================================================================
...
COMMENT ON TABLE  dim_factory IS 'Tesla全球工厂主数据，含产能、认证、可再生能源比例';
...
COMMENT ON COLUMN dim_production_line.designed_takt_sec IS '设计节拍（秒），Tesla追求极端节拍如Giga Press 90秒';
